    ...
    <body>
        ...
        <div class="row justify-content-md-center" style="margin: 0; margin-top: 3%">
            ...
            foreach ($resultaatvergelijkbareproducten as $vergelijkbareproducten) {
                ?>
                <div class="margincol-sm-6" style="padding: 2%; background-color: #EEEEEE">
                    <div class="col" style="height: 250px; padding: 1%; padding-top: 0;" onclick="window.location = 'ProductPagina.php?product=<?php print($vergelijkbareproducten['StockItemID']); ?>';">
            ...
            <div class="margincol-sm-6" style="padding: 2%; background-color: #EEEEEE">
                <div class="col" style="height: 700x; width: 800px; padding: 1%; padding-top: 0;">
                    ...
                    <div class="row">
                        ...
                        <div class="middle">
                            <div class="bar-container">
                                <div class="bar-4" style="margin: 0 auto; width: <?php print($fourstarpercentage); ?>%";></div>
                            </div>
                        </div>
                        <div class="side right">
